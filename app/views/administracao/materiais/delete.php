...
<div class="row justify-content-center">
    <div class="col-md-6">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="mb-0 fw-bold" style="color: #1e293b;">Eliminar Material</h4>
            <a href="<?php echo BASE_URL; ?>admin/materiais" class="btn-outline-clean" style="padding: 8px 16px;">Voltar</a>
        </div>
        ...
        <div class="clean-card p-5 text-center" style="border-top: 6px solid #ef4444;">
            ...
            <p style="color: #475569; font-size: 1.05rem; margin-bottom: 35px; line-height: 1.6;">
                Está prestes a eliminar permanentemente o material <strong style="color: #0f172a; background-color: #f1f5f9; padding: 4px 10px; border-radius: 6px;"><?php echo htmlspecialchars($material['designacao'] ?? ''); ?></strong>.
            </p>
            
            <form id="deleteFormMaterial" method="POST" action="<?php echo BASE_URL; ?>admin/materialDestroy/<?php echo (int)$material['id']; ?>" class="d-flex justify-content-center gap-3">
                <a href="<?php echo BASE_URL; ?>admin/materiais" class="btn-outline-clean">Cancelar</a>
                <button type="submit" class="btn-danger-clean" id="btnDeleteMaterial"><i class="fas fa-trash-alt me-2"></i>Sim, Eliminar</button>
            </form>
        </div>
    </div>
</div>
...
<script>
    const formDeleteMaterial = document.getElementById('deleteFormMaterial');
    if(formDeleteMaterial) {
        formDeleteMaterial.addEventListener('submit', function() {
