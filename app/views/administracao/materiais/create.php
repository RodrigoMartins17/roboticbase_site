...
<div class="row justify-content-center">
    <div class="col-md-7">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="mb-0 fw-bold" style="color: #1e293b;">Adicionar Material</h4>
        ...
        <div class="clean-card p-4 p-md-5">
            ...
            <form id="createForm" method="post" enctype="multipart/form-data" action="<?php echo BASE_URL; ?>admin/materialStore">

                <div class="mb-4">
                    <label style="font-size: 0.85rem; font-weight: 600; color: #475569; margin-bottom: 8px; display: block;">Designação do Material *</label>
                    <input type="text" name="designacao" class="form-control-clean" required placeholder="Exemplo: Multímetro, Arduino Uno...">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <select name="categoria_id" class="form-control-clean">
                        ...
                        <?php foreach ($categorias as $c): ?>
                            <option value="<?php echo (int)$c['id']; ?>"><?php echo htmlspecialchars($c['categoria']); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="descricao" class="form-control-clean" rows="4" placeholder="Detalhes técnicos ou outras informações relevantes..."></textarea>
                </div>

                <div class="mb-5">
                    <label style="font-size: 0.85rem; font-weight: 600; color: #475569; margin-bottom: 8px; display: block;">Imagem (Opcional)</label>
