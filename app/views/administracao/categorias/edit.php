...
<div class="row justify-content-center">
    <div class="col-md-7">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="mb-0 fw-bold" style="color: #1e293b;">Editar Categoria</h4>
        ...
        <div class="clean-card p-4 p-md-5">
            ...
            <form id="editForm" method="post" enctype="multipart/form-data" action="<?php echo BASE_URL; ?>Categoria/update/<?php echo (int)$categoria['id']; ?>"> 
                <div class="mb-4">
                    <label style="font-size: 0.85rem; font-weight: 600; color: #475569; margin-bottom: 8px; display: block;">Nome da Categoria</label>
                    <input type="text" name="categoria" class="form-control-clean" required value="<?php echo htmlspecialchars($categoria['categoria'] ?? ''); ?>">
                </div>
                
                <div class="row mb-5 align-items-end pt-3 border-top" style="border-color: #e2e8f0 !important;">
                    <div class="col-md-3">
                        <label style="font-size: 0.85rem; font-weight: 600; color: #475569; margin-bottom: 8px; display: block;">Imagem Atual</label>
                        <?php if (!empty($categoria['imagem_src'])): ?>
                            <img src="<?php echo htmlspecialchars($categoria['imagem_src']); ?>" style="height: 80px; width: 80px; object-fit: cover; border-radius: 12px; border: 1px solid #e2e8f0;">
                        <?php else: ?>
