...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="mb-0 fw-bold" style="color: #1e293b;">Editar Utilizador</h4>
        ...
        <div class="clean-card p-4 p-md-5 mb-5">
            ...
            <form id="editForm" method="post" enctype="multipart/form-data" action="<?php echo BASE_URL; ?>admin/utilizadorUpdate/<?php echo (int)$user['id']; ?>">
                
                <div class="row g-4 mb-4">
                    <div class="col-md-6">
                        <label style="font-size: 0.85rem; font-weight: 600; color: #475569; margin-bottom: 8px; display: block;">Nome *</label>
                        <input type="text" name="nome" class="form-control-clean" required value="<?php echo htmlspecialchars($user['nome'] ?? ''); ?>">
                    </div>
                    <div class="col-md-6">
                        <label style="font-size: 0.85rem; font-weight: 600; color: #475569; margin-bottom: 8px; display: block;">Email *</label>
                        <input type="email" name="email" class="form-control-clean" required value="<?php echo htmlspecialchars($user['email'] ?? ''); ?>">
                    </div>
                </div>
                ...
                <div class="row g-4 mb-4">
                    <div class="col-md-6">
                        ...
                        <select name="tipo" class="form-control-clean">
                            <?php
                            $tipos = ['ALUNO' => 'Aluno', 'PROFESSOR' => 'Professor', 'RESPONSAVEL' => 'Responsável', 'ADMIN' => 'Admin'];
                            $tipoAtual = $user['tipo'] ?? '';
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="telefone" class="form-control-clean" maxlength="20" value="<?php echo htmlspecialchars($user['telefone'] ?? ''); ?>">
                    </div>
                </div>
                ...
                <div class="row g-4 mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="turma" class="form-control-clean" maxlength="10" value="<?php echo htmlspecialchars($user['turma'] ?? ''); ?>">
                    </div>
                    <div class="col-md-6">
                        <label style="font-size: 0.85rem; font-weight: 600; color: #475569; margin-bottom: 8px; display: block;">Data de Nascimento</label>
                        <input type="date" name="data_nascimento" class="form-control-clean" value="<?php echo htmlspecialchars($user['data_nascimento'] ?? ''); ?>">
                    </div>
                </div>
                ...
                <div class="row g-4 mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="url" name="linkedin" class="form-control-clean" value="<?php echo htmlspecialchars($user['linkedin'] ?? ''); ?>">
                    </div>
                    <div class="col-md-6">
                        <label style="font-size: 0.85rem; font-weight: 600; color: #475569; margin-bottom: 8px; display: block;">Palavra-passe Nova</label>
                        <input type="password" name="palavra_passe" class="form-control-clean" placeholder="Deixe em branco para manter a atual">
                    </div>
                </div>
                ...
                <div class="row align-items-center mb-5 mt-2">
                    <div class="col-md-3 mb-3 mb-md-0 text-center text-md-start">
                        <?php if (!empty($user['foto'])): ?>
                            <img src="<?php echo $utilizadorModel->getAvatarUrl($user); ?>" alt="Avatar" style="width: 70px; height: 70px; object-fit: cover; border-radius: 50%; border: 3px solid #f1f5f9;">
                        <?php else: ?>
                            <div style="width: 70px; height: 70px; border-radius: 50%; background-color: #f8fafc; display: flex; align-items: center; justify-content: center; color: #94a3b8; border: 1px dashed #cbd5e1; font-size: 1.5rem;"><i class="fas fa-user"></i></div>
                        <?php endif; ?>
                    </div>
                    <div class="col-md-9">
                        <label style="font-size: 0.85rem; font-weight: 600; color: #475569; margin-bottom: 8px; display: block;">Atualizar Foto de Perfil</label>
                ...
                <div class="mb-5">
                    <label style="display: flex; align-items: center; gap: 10px; cursor: pointer; background-color: #f8fafc; padding: 12px 16px; border-radius: 10px; border: 1px solid #e2e8f0;">
                        <input type="checkbox" name="responsavel" value="1" style="width: 18px; height: 18px; cursor: pointer;" <?php echo ($user['tipo'] ?? '') === 'RESPONSAVEL' ? 'checked' : ''; ?>>
