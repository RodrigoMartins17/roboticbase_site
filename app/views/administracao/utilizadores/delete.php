...
<div class="form-wrapper">
    <div class="form-card" style="border-top: 6px solid var(--tech-error);">
        ...
        <p>
            Está prestes a eliminar permanentemente o utilizador <span class="user-highlight"><?php echo htmlspecialchars($user['nome'] ?? ''); ?></span>.
            Esta ação não pode ser desfeita.
        </p>
        
        <form id="deleteFormUser" method="POST" action="<?php echo BASE_URL; ?>admin/utilizadorDestroy/<?php echo (int)$user['id']; ?>">
            <div class="form-actions">
                <a href="<?php echo BASE_URL; ?>admin/utilizadores" class="btn-tech btn-cancel">
                    <i class="fas fa-times"></i> Cancelar
                </a>
                <button type="submit" class="btn-tech btn-danger" id="btnDeleteUser">
...
document.addEventListener('DOMContentLoaded', function() {
    const formDeleteUser = document.getElementById('deleteFormUser');
    if(formDeleteUser) {
        formDeleteUser.addEventListener('submit', function() {
